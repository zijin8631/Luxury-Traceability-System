...
class UTXOSet(Singleton):
    ...
    def __init__(self, db_url=db_url):
        # if self has db attribute, return true, or return false
        # if self doesn't have db, add this attribute to self.
    ...
    def update(self, block):
        ...
        for tx in block.transactions:
            txid = tx.txid
            key = self.FLAG + txid
            # add uxto (add the transaction in the block)
    ...
    def find_utxo(self, address):
        ...
        for doc in docs:
            ...
            # When find an output of the this utxo, add it in the final output one by one.
            utxos.append(ftxo)
        return utxos
